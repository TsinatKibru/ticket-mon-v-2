  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center h-full">
      <div className="relative mb-12">
        <div className="absolute inset-0 blur-3xl bg-base-content/5 rounded-full scale-150" />
        <img
      ...
      <h1 className="text-4xl font-bold font-outfit tracking-tighter text-base-content mb-4">
        Everything you need,<br />
        <span className="opacity-40">nothing you don't.</span>
      </h1>

      <p className="text-base-content/30 text-sm max-w-[280px] leading-relaxed font-medium">
